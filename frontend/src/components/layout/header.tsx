...
import { Menu, X, Target, Phone, User, LogIn, LogOut, Key, UserPlus, LayoutDashboard } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import { useAppDispatch, useAppSelector } from "@/store";
import { checkAuthUser, logoutUser } from "@/store/slices/authSlice";
          ...
          <div className="hidden md:flex md:items-center md:gap-4">
            ...
            {!user ? (
              <>
                <Link
                  to="/login"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 transition-all duration-300 font-semibold text-sm"
                >
