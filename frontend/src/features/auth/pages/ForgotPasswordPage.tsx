...
export const ForgotPasswordPage = () => {
  ...
  const onSubmit = async (data: ForgotPasswordSchemaType) => {
    setIsLoading(true);
    try {
      const response: any = await apiClient.post("/forget-password", { email: data.email });
            ...
            {!isSubmitted ? (
              ...
              <div className="text-center space-y-6 py-4 animate-fade-in">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-500 leading-relaxed">
                    We've sent a password reset link to <strong className="text-gray-700">{submittedEmail}</strong>. Please check your inbox.
                  </p>
                </div>
                ...
                <div className="p-4 bg-orange-50/50 border border-orange-100 rounded-2xl text-xs text-left text-orange-800 leading-relaxed">
                  ...
                  <div className="mt-2 text-right">
                    ...
                    <Link
                      to={`/reset-password/dev-demo-token?email=${encodeURIComponent(submittedEmail)}`}
